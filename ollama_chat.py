...
class OllamaChat(app_commands.Group):
    ...
    @app_commands.command(name="ask", description="Interact with the Sorting Hat's magical AI wisdom!")
...
async def setup(hat):
    hat.tree.add_command(OllamaChat(name="chatgpt", description="Converse with the Sorting Hat's magical AI wisdom!"))